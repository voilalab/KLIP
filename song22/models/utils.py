...
def init_model(rng, config):
  ...
  # print(type(variables['params']))
  # print(list(variables['params'].keys()))
  # print(len(list(variables['params'].keys())))
  # exit()
  # init_model_state, initial_params = variables.pop('params')

  init_model_state = frozen_dict.freeze({})
  initial_params = frozen_dict.freeze(variables['params'])
